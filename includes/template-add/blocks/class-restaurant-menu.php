        ...
        public function add_block_template_library( $templates_list ){
            ...
            $block_library_list = array(
				...
				array(
					...
					'template_url'		=> GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/restaurant-menu/restaurant-menu-1/gutentor_restaurant-menu.json',
					'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/restaurant-menu/restaurant-menu-1/restaurant-menu.jpg',
				...
				array(
					...
					'categories'		=> array( 'restaurant-menu' ),
					'template_url'		=> GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/restaurant-menu/restaurant-menu-2/gutentor_restaurant-menu.json',
					'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/restaurant-menu/restaurant-menu-2/restaurant-menu.jpg',
				...
				array(
					...
					'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/restaurant-menu/restaurant-menu-3/restaurant-menu.jpg',
