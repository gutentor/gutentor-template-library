        ...
        public function add_block_template_library( $templates_list ){
            ...
            $block_library_list = array(
                ...
                array(
					...
					'template_url'		=> GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/list/list-1/gutentor_list.json',
					'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/list/list-1/list.jpg',
				...
				array(
					...
					'categories'		=> array( 'list' ),
					'template_url'		=> GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/list/list-2/gutentor_list.json',
					'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/list/list-2/list.jpg',
				...
				array(
					...
					'categories'		=> array( 'list' ),
					'template_url'		=> GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/list/list-3/gutentor_list.json',
					'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/list/list-3/list.jpg',
