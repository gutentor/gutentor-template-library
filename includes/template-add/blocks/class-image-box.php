        ...
        public function add_block_template_library( $templates_list ){
            ...
            $block_library_list = array(
                ...
                array(
					...
					'template_url'		=> GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/image-box/image-box-1/gutentor_image-box.json',
					'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/image-box/image-box-1/image-box.jpg',
				...
				array(
					...
					'categories'		=> array( 'image-box' ),
					'template_url'		=> GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/image-box/image-box-2/gutentor_image-box.json',
					'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/image-box/image-box-2/image-box.jpg',
				...
				array(
					...
					'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/image-box/image-box-3/image-box.jpg',
				...
				array(
					...
					'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/image-box/image-box-4/image-box.jpg',
					'demo_url'    => 'https://www.demo.cosmoswp.com/demo-1/#section-06760ad3-ac34-4c73-9ab4-7163e1a33b1a',
				),
