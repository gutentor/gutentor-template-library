        ...
        public function add_block_template_library( $templates_list ){
            ...
            $block_library_list = array(
                ...
                array(
					...
					'template_url'		=> GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/icon-box/icon-box-1/gutentor_icon-box.json',
					'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/icon-box/icon-box-1/icon-box.jpg',
				...
				array(
					...
					'categories'		=> array( 'icon-box' ),
					'template_url'		=> GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/icon-box/icon-box-2/gutentor_icon-box.json',
					'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/icon-box/icon-box-2/icon-box.jpg',
				...
				array(
					...
					'categories'		=> array( 'icon-box' ),
					'template_url'		=> GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/icon-box/icon-box-3/gutentor_icon-box.json',
					'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/icon-box/icon-box-3/icon-box.jpg',
				...
				array(
					...
					'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/icon-box/icon-box-4/icon-box.jpg',
				...
				array(
					...
					'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/icon-box/icon-box-5/icon-box.jpg',
				...
				array(
					...
					'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/icon-box/icon-box-6/icon-box.jpg',
				...
				array(
					...
					'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/icon-box/icon-box-7/icon-box.jpg',
				...
				array(
					...
					'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/icon-box/icon-box-8/icon-box.jpg',
				...
				array(
					...
					'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/icon-box/icon-box-9/icon-box.jpg',
				...
				array(
					...
					'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/blocks/icon-box/icon-box-10/icon-box.jpg',
