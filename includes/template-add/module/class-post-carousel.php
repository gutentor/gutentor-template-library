        ...
        public function add_block_template_library( $templates_list ){
            ...
            $block_library_list = array(
                ...
                array(
					...
					'template_url'		=> GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/module/post-carousel/template-1/gutentor_p3.json',
					'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/module/post-carousel/template-1/template-1.jpg',
				...
				array(
					...
					'categories'		=> array( 'post-carousel' ),
					'template_url'		=> GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/module/post-carousel/template-2/gutentor_p3.json',
					'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/module/post-carousel/template-2/template-2.jpg',
				...
				array(
					...
					'categories'		=> array( 'post-carousel' ),
					'template_url'		=> GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/module/post-carousel/template-3/gutentor_p3.json',
					'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_URL.'includes/template-data/module/post-carousel/template-3/template-3.jpg',
