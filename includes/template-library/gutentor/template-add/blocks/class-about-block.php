	...
	class Gutentor_Template_Library_Block_About_Block extends Gutentor_Template_Library_Base{
        ...
        public function add_block_template_library( $templates_list ){
            ...
            $block_library_list = array(
				...
				// 	'categories'		=> array( 'about' ),
				// 	'template_url'		=> GUTENTOR_TEMPLATE_LIBRARY_GUTENTOR_URL.'template-data/blocks/about-block/about-3/gutentor_about-block.json',
				// 	'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_GUTENTOR_URL.'template-data/blocks/about-block/about-3/about-block.jpg',
				...
				// 	'categories'		=> array( 'about' ),
				// 	'template_url'		=> GUTENTOR_TEMPLATE_LIBRARY_GUTENTOR_URL.'template-data/blocks/about-block/about-4/gutentor_about-block.json',
				// 	'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_GUTENTOR_URL.'template-data/blocks/about-block/about-4/about-block.jpg',
