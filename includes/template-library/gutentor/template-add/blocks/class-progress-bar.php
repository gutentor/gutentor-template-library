        ...
        public function add_block_template_library( $templates_list ){
            ...
            $block_library_list = array(
				...
				array(
					...
					'template_url'		=> GUTENTOR_TEMPLATE_LIBRARY_GUTENTOR_URL.'template-data/blocks/progress-bar/progress-bar-1/gutentor_progress-bar.json',
					'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_GUTENTOR_URL.'template-data/blocks/progress-bar/progress-bar-1/progress-bar.jpg',
				...
				array(
					...
					'categories'		=> array( 'progress-bar' ),
					'template_url'		=> GUTENTOR_TEMPLATE_LIBRARY_GUTENTOR_URL.'template-data/blocks/progress-bar/progress-bar-2/gutentor_progress-bar.json',
					'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_GUTENTOR_URL.'template-data/blocks/progress-bar/progress-bar-2/progress-bar.jpg',
