        ...
        public function add_block_template_library( $templates_list ){
            ...
            $block_library_list = array(
				...
				array(
					...
					'template_url'		=> GUTENTOR_TEMPLATE_LIBRARY_GUTENTOR_URL.'template-data/blocks/gallery/gallery-1/gutentor_gallery.json',
					'screenshot_url'    => GUTENTOR_TEMPLATE_LIBRARY_GUTENTOR_URL.'template-data/blocks/gallery/gallery-1/gallery.jpg',
				...
				array(
					...
					'categories'		=> array( 'gallery' ),
					'template_url'		=> GUTENTOR_TEMPLATE_LIBRARY_GUTENTOR_URL.'template-data/blocks/gallery/gallery-2/gutentor_gallery.json',
