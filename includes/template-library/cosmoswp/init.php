...
class Gutentor_Template_Library_CosmosWP {
    ...
    private function load_dependencies() {
        ...
        require_once GUTENTOR_TEMPLATE_LIBRARY_COSMOSWP_PATH . 'demo-4/template-add.php';
        ...
        require_once GUTENTOR_TEMPLATE_LIBRARY_COSMOSWP_PATH . 'demo-9/template-add.php';
        require_once GUTENTOR_TEMPLATE_LIBRARY_COSMOSWP_PATH . 'demo-10/template-add.php';
        require_once GUTENTOR_TEMPLATE_LIBRARY_COSMOSWP_PATH . 'demo-11/template-add.php';
        require_once GUTENTOR_TEMPLATE_LIBRARY_COSMOSWP_PATH . 'demo-12/template-add.php';
        require_once GUTENTOR_TEMPLATE_LIBRARY_COSMOSWP_PATH . 'demo-13/template-add.php';
        require_once GUTENTOR_TEMPLATE_LIBRARY_COSMOSWP_PATH . 'demo-14/template-add.php';
        require_once GUTENTOR_TEMPLATE_LIBRARY_COSMOSWP_PATH . 'demo-15/template-add.php';
        require_once GUTENTOR_TEMPLATE_LIBRARY_COSMOSWP_PATH . 'demo-16/template-add.php';
